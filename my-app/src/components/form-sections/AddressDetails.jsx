...
const AddressDetails = ({ data, onInputChange, errors, disabled }) => {
  if (disabled) {
    return (
      <div className="bg-gray-50 p-6 rounded-lg shadow-sm">
        <h2 className="text-xl font-semibold mb-4 text-gray-900">Residential Address</h2>
        <div className="grid gap-4">
          <div className="field-display border-b border-gray-200 pb-2">
            <span className="font-medium text-gray-700">Unit Number:</span>
            <span className="text-gray-900">{data.unitNumber || 'N/A'}</span>
          </div>
          <div className="field-display border-b border-gray-200 pb-2">
            <span className="font-medium text-gray-700">Street Number:</span>
            <span className="text-gray-900">{data.streetNumber}</span>
          </div>
          <div className="field-display border-b border-gray-200 pb-2">
            <span className="font-medium text-gray-700">Street Name:</span>
            <span className="text-gray-900">{data.streetName}</span>
          </div>
          <div className="field-display border-b border-gray-200 pb-2">
            <span className="font-medium text-gray-700">PO Box:</span>
            <span className="text-gray-900">{data.poBox || 'N/A'}</span>
          </div>
          <div className="field-display border-b border-gray-200 pb-2">
          ...
          <div className="field-display border-b border-gray-200 pb-2">
            ...
            <span className="text-gray-900">{data.province}</span>
          </div>
          <div className="field-display border-b border-gray-200 pb-2">
            <span className="font-medium text-gray-700">Postal Code:</span>
            <span className="text-gray-900">{data.postalCode}</span>
          </div>
        </div>
      </div>
    );
